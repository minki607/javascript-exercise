...
var axios = __webpack_require__(/*! axios */ "./node_modules/axios/index.js"); // State
...
var updateTodos = function updateTodos(_todos) {
  todos = _todos;
  render();
};
...
var addTodo = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(content) {
    var res;
...
var removeCompleted = function removeCompleted() {
  ...
  axios["delete"]('/todos/completed').then(function (res) {
    return updateTodos(res.data);
  })["catch"](console.error);
};
...
$inputTodo.onkeyup = function (_ref6) {
